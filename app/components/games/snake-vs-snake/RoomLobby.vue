<template>
  <div class="lobby">
    <h2 class="lobby-title">SNAKE VS SNAKE</h2>
...
.refresh-btn:hover:not(:disabled) { border-color: var(--neon-yellow); color: var(--neon-yellow); }
...
.room-item:hover { border-color: #ffe60044; }
...
.join-btn:hover:not(:disabled) { background: var(--neon-yellow); color: var(--bg); }
...
.create-btn:hover:not(:disabled) { background: var(--neon-yellow); color: var(--bg); }
